...
export default function Navbar({
  ...
  // ✅ MAIN ADMIN PANEL IS ONLY IN FRONTEND1 (PORT 3000)
  ...
  const navLinks = [
    ...
    { href: "/contact-c", label: "Contact C" },
      ...
      >
        ...
        >
          ...
          <div className="hidden lg:flex items-center gap-2">
            ...
            {/* ✅ Admin Button (Redirect to FRONTEND1 Admin Panel) */}
            <a
              href={ADMIN_URL}
              target="_blank"
              rel="noreferrer"
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden pb-4 pt-2 space-y-2">
            ...
            {/* ✅ Mobile Admin Button (Redirect to FRONTEND1 Admin Panel) */}
            <a
              href={ADMIN_URL}
              target="_blank"
              rel="noreferrer"
